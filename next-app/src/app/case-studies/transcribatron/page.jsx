...
export const metadata = {
  title: "Transcribatron Case Study — Slate Studio | iOS Voice Intelligence App",
  description:
    "How Slate Studio built Transcribatron, a privacy-first iOS app that turns voice into polished text using on-device AI. Native Swift app case study from Kitchener-Waterloo.",
  openGraph: {
    title: "Transcribatron Case Study — Slate Studio | Kitchener-Waterloo",
    description:
      "Privacy-first voice-to-text iOS app with on-device transcription and multi-provider AI. Built by Slate Studio.",
  },
  alternates: {
    canonical: "https://slatecode.dev/case-studies/transcribatron",
  },
}
...
export default function TranscribatronCaseStudy() {
  return (
    <div className="min-h-screen">
      ...
      <main className="w-full max-w-4xl mx-auto px-5 md:px-8 pt-20 md:pt-50">
        ...
        <h1 className="text-5xl font-medium mb-4">Transcribatron</h1>
        ...
        <section className="mb-16">
          ...
          <div className="text-white/60 text-lg leading-relaxed space-y-4">
            ...
            <p>
              Transcription runs on-device using WhisperKit, an
              implementation of OpenAI&apos;s Whisper model optimized for
              Apple hardware. It uses the Neural Engine when available and
              falls back to the GPU. The result is fast, accurate
              transcription with zero network dependency.
            </p>
            <p>
        ...
        <section className="mb-16">
          ...
          <div className="text-white/60 text-lg leading-relaxed space-y-4">
            <p>
              ...
              entirely on-device, which meant integrating WhisperKit and
              optimizing it for Apple&apos;s Neural Engine. We built a
              fallback chain, Neural Engine first, then GPU, then CPU, so the
            ...
            <p>
              ...
              We built an IPC layer using App Groups and Darwin notifications
              so the keyboard can trigger recording and receive processed text
              back from the main app without violating any sandbox rules.
            </p>
            <p>
              For the AI layer, we built a provider-agnostic post-processing
              system. Each provider, Claude, OpenAI, Gemini, Grok, and the
              local Qwen model, implements the same protocol. Switching
              providers is a single setting change with zero impact on the
              rest of the app. The cost calculator pulls pricing data for each
              model so users can make informed decisions.
            </p>
            <p>
              Data persistence uses SwiftData with CloudKit sync. Six schema
              versions with automated migrations, encrypted iCloud sync across
              devices, and shared containers for extension access. The user
