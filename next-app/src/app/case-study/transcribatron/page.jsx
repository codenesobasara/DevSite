...
export const metadata = {
  ...
  description:
    "How we built Transcribatron, a privacy-first iOS app that turns voice into polished text using on-device AI. Native Swift app case study.",
  openGraph: {
    title: "Transcribatron Case Study | Pontera Studios",
    description:
      "Privacy-first voice-to-text iOS app with on-device transcription and multi-provider AI. Built by Pontera Studios.",
  },
  alternates: {
    canonical: "https://www.ponterastudios.com/case-study/transcribatron",
  },
}
