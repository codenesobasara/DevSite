...
export const metadata = {
  ...
  openGraph: {
    title: "Case Studies | Pontera Studios",
    description: "Real projects and real results. See how we've helped businesses solve problems with custom software.",
  },
  alternates: {
    canonical: "https://www.ponterastudios.com/case-study",
  },
}
...
export default function CaseStudies() {
  return (
    <div className="min-h-screen bg-[#111111] text-white">
      <JsonLd data={schemas.breadcrumbs([{name: 'Home', path: '/'}, {name: 'Case Studies', path: '/case-study'}])} />
