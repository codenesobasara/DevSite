...
export const metadata = {
  ...
  openGraph: {
    title: "Basara Case Study | Pontera Studios",
    description: "Hyperlocal real estate market intelligence platform for the Waterloo Region.",
  },
  alternates: {
    canonical: "https://www.ponterastudios.com/case-study/basara",
  },
}

export default function BasaraCaseStudy() {
  return (
    <div className="min-h-screen bg-[#111111] text-white">
      <JsonLd data={schemas.breadcrumbs([{name: 'Home', path: '/'}, {name: 'Case Studies', path: '/case-study'}, {name: 'Basara', path: '/case-study/basara'}])} />
