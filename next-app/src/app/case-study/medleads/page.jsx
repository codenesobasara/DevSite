...
export const metadata = {
  ...
  description:
    "How we built MedLeads, a real-time lead capture and analytics platform for healthcare trade shows. Full-stack web application with Angular, Node.js, and WebSockets.",
  openGraph: {
    title: "MedLeads Case Study | Pontera Studios",
    description:
      "Real-time lead intelligence for medical events. Full-stack platform built by Pontera Studios.",
  },
  alternates: {
    canonical: "https://www.ponterastudios.com/case-study/medleads",
  },
}
