...
export const metadata = {
  ...
  openGraph: {
    title: "Focus Point Media Case Study | Pontera Studios",
    description: "How we rebuilt a photography studio's WordPress site into a high-performance marketing platform.",
  },
  alternates: {
    canonical: "https://www.ponterastudios.com/case-study/focuspoint",
  },
}

export default function FocusPointCaseStudy() {
  return (
    <div className="min-h-screen bg-[#111111] text-white">
      <JsonLd data={schemas.breadcrumbs([{name: 'Home', path: '/'}, {name: 'Case Studies', path: '/case-study'}, {name: 'Focus Point Media', path: '/case-study/focuspoint'}])} />
